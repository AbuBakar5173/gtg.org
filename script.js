...
document.querySelector(".input").addEventListener("change", function () {
    ...
    if (this.checked) {
        ...
        document.body.querySelector("#special-case").style.background = "none";
        document.body.querySelector("#special-case").style.border = "2px solid var(--main-grey)";
    } else {
        // Light mode
        ...
        document.body.querySelector("#special-case").style.background = "var(--primary-300)";
        document.body.querySelector("#special-case").style.border = "none";
    }
});

// Saved theme on page load
...
document.querySelector(".left").insertAdjacentHTML("afterbegin", Hamburger);
